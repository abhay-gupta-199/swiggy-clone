  ...
  return (
    <div className="m-12">
      <h1 className="text-xl font-bold">
        Restaurants with online food delivery in Aligarh
      </h1>
      <button
        onClick={() => handleTopRest(allRestaurants)}
        className={
          isClicked1
            ? "bg-amber-200 border rounded-3xl m-4 p-4 text-2xl"
            : "border rounded-3xl m-4 p-4 text-2xl"
        }
      >
        Rating 4.2+
      </button>
      <button
        onClick={() => handleReset(allRestaurants)}
        className={
          isClicked2
            ? "bg-amber-200 border rounded-3xl m-4 p-4 text-2xl"
            : "border rounded-3xl m-4 p-4 text-2xl"
